...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'duty.preset.parking': { en: 'Parking', hi: 'पार्किंग' },
  ...
  // Report
  'report.title': { en: 'REPORTS', hi: 'प्रतिवेदन्स' },
  'report.subtitle': { en: 'Society summary, finance net & export', hi: 'सोसाइटी सार, वित्त नेट और निर्यात' },
  'report.financeSummaryReceipts': { en: 'Receipts & ledger (by mode)', hi: 'रसीद और लेजर (विधि अनुसार)' },
  'report.financeNetTitle': { en: 'Month net (verified ledger)', hi: 'महीने का नेट (सत्यापित लेजर)' },
  ...
  'report.splitwiseFromGroupsHint': {
    ...
    hi: 'अभिलेख भुगतान के तहत सामान्य समाज भुगतान — सक्रिय अभिलेख। इवेंट भोजन इवेंट्स में।',
  },
  ...
  'adminNav.guards': { en: 'Guards', hi: 'गार्ड्स' },
  ...
  'adminNav.meetings': { en: 'Meetings', hi: 'मीटिंग्स' },
  ...
  'adminNav.events': { en: 'Events & food', hi: 'इवेंट्स व भोजन' },
  'adminNav.polls': { en: 'Polls & Elections', hi: 'पोल व चुनाव' },
  'adminNav.notify': { en: 'Notify', hi: 'सूचना' },
  'adminNav.parking': { en: 'Parking', hi: 'पार्किंग' },
  ...
  'adminNav.settings': { en: 'Settings', hi: 'सेटिंग्स' },
  'adminNav.tour': { en: 'Tour', hi: 'मार्गदर्शन' },
  'adminNav.allModules': { en: 'All modules', hi: 'सभी मॉड्यूल' },
  'adminNav.quickAccess': { en: 'Quick access', hi: 'त्वरित पहुँच' },
  'adminNav.search': { en: 'Search across modules', hi: 'मॉड्यूल में खोजें' },
  ...
  'resident.polls': { en: 'Polls', hi: 'पोल' },
  'resident.meetings': { en: 'Meetings', hi: 'मीटिंग्स' },
  ...
  'votingCharter.program.s6.title': { en: 'Publish roster and first meeting', hi: 'रोस्टर प्रकाशित करें और पहली बैठक' },
  'votingCharter.program.s6.detail': {
    ...
    hi: 'प्रकाशन के बाद सदस्य समिति मॉड्यूल में समिति देख सकते हैं। पहली प्रबंध समिति बैठक चुनाव के 30 दिनों के भीतर निर्धारित होनी चाहिए। सामान्य बैठक कोरम 7 में से 5 है; नियमित बैठकें कम-से-कम मासिक, सात स्पष्ट दिनों की सूचना के साथ।',
  },
  ...
  'votingCharter.nomination.p1': {
    ...
    hi: 'जब प्रशासक नामांकन विंडो खोलता है, पात्र सदस्य प्रबंध समिति के पदों — अध्यक्ष, उपाध्यक्ष, सचिव, कोषाध्यक्ष या कार्यकारिणी सदस्य — के लिए स्वयं को प्रस्तावित कर सकते हैं।',
  },
  ...
  'votingCharter.method.p4': {
    ...
    hi: 'मतदान केवल प्रशासक द्वारा निर्धारित मतदान विंडो में और चुनाव कोरम (सदस्यों का 3/4) पूरा होने पर ही अनुमत है।',
  },
  ...
  'votingCharter.docs.p1': {
    ...
    hi: 'प्रशासक चुनाव में परिपत्र, पत्र या अन्य सोसाइटी दस्तावेज़ संलग्न कर सकता है; सदस्य उन्हें पोल से खोल सकते हैं।',
  },
  ...
  'votingCharter.docs.p3': {
    ...
    hi: 'निर्वाचित समिति के नाम निवासी समिति मॉड्यूल में तभी दिखते हैं जब प्रशासक रोस्टर प्रकाशित करता है।',
  },
