...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'guard.preview.hint': {
    ...
    hi: 'प्रवेश के बाद क्या कर सकते हैं देखें। पूरा मार्गदर्शन के लिए मार्गदर्शन दबाएँ।',
  },
  ...
  'login.superadminPlatform': { en: 'Platform superadmin login', hi: 'प्लेटफ़ॉर्म मुख्य प्रशासक प्रवेश' },
  ...
  'signup.pincode': { en: 'Pincode', hi: 'पिनकोड' },
  'signup.totalFloors': { en: 'Total floors', hi: 'कुल मंजिलें' },
  'signup.blocks': { en: 'Blocks / wings (e.g. A, B)', hi: 'ब्लॉक्स / विंग (जैसे A, B)' },
  ...
  'signup.contactEmail': { en: 'Contact email', hi: 'संपर्क ईमेल' },
  ...
  'login.noFlatsForSociety': {
    ...
    hi: 'इस सोसाइटी के लिए अभी कोई फ्लैट दर्ज नहीं है। प्रशासक से निर्देशिका में फ्लैट जोड़ने को कहें। (सोसाइटी के फ्लैट नंबरिंग फ़ील्ड अपने आप फ्लैट नहीं बनाते।)',
  },
  ...
  'tour.guard.w2.title': { en: 'Home dashboard', hi: 'मुख्य पृष्ठ मुख्य पटल' },
  'tour.guard.w2.body': {
  ...
  'tour.res.r3.body': {
    ...
    hi: 'मेहमानों के लिए तारीख/समय के साथ ओटीपी पास बनाएं। कोड साझा करें; गार्ड द्वार पर सत्यापित करेंगे।',
  },
  ...
  'tour.super.s1.body': {
    ...
    hi: 'आप प्लेटफ़ॉर्म की हर सोसाइटी प्रबंधित करते हैं: ब्रांड-पहचान, फ्लैट सीमा, बैकअप, प्रशासक पहुँच।',
  },
  ...
  'tour.super.s4.body': {
    ...
    hi: 'सोसाइटी प्रशासक बनाएँ, भूमिका दें, कूटशब्द रीसेट के लिए पुनर्प्राप्ति ईमेल रखें।',
  },
  ...
  'tour.super.s6.body': {
    ...
    hi: 'समय-आधारित ओटीपी, पुनर्प्राप्ति ईमेल, जैवमितीय इस उच्चतम खाते की सुरक्षा करते हैं।',
  },
  ...
  'tour.admin.a2.title': { en: 'Home cards', hi: 'मुख्य पृष्ठ कार्ड' },
  'tour.admin.a2.body': {
  ...
  'tour.admin.op1.title': { en: 'Visitor console', hi: 'आगंतुक कंसोल' },
  'tour.admin.op1.body': {
  ...
  'tour.admin.rp2.body': {
    ...
    hi: 'आगंतुक लॉग में गहरी खोज, श्रेणी/गार्ड छानबीन।',
  },
  ...
  'tour.admin.sc1.title': { en: 'Password rotation', hi: 'कूटशब्द रोटेशन' },
  'tour.admin.sc1.body': {
    en: 'Change your admin password regularly and keep recovery email in sync with superadmin records.',
    hi: 'कूटशब्द बदलते रहें; पुनर्प्राप्ति ईमेल अद्यतन रखें।',
  },
  ...
  'tour.first.guard.more.body': {
    ...
    hi: 'आगंतुक, वाहन, काली सूची पर रिफ्रेशर के लिए मार्गदर्शन खंड देखें।',
  },
  ...
  'settings.bannersHint': {
    ...
    hi: 'ये चित्र निवासी मुख्य पटल पर प्रवेश के बाद उभरती संदेश श्रृंखला के रूप में दिखते हैं (केवल मुख्य पटल)। शीर्षक शुद्ध हिंदी (देवनागरी) में लिखें — रोमन हिंग्लिश जैसे “आगंतुकों के लिए नियम” से बचें।',
  },
  ...
  'superadmin.recoveryRequestHelp': { en: 'Enter your super admin username and the recovery email on file. We will send a 6-digit code.', hi: 'सुपर प्रशासक उपयोगकर्ता नाम और दर्ज पुनर्प्राप्ति ईमेल दर्ज करें। हम 6 अंकों का कोड भेजेंगे।' },
  ...
  'superadmin.flatsTrimmed': {
    ...
    hi: '{count} फ्लैट हटाए गए जो निर्धारित की गई सीमा के बाहर थे।',
  },
  'superadmin.societyPhotos': { en: 'Society photos', hi: 'सोसाइटी फोटो' },
  'superadmin.societyPhotosHint': { en: 'Up to 12 images, 8 MB each. Shown in the directory; logo URL is separate.', hi: 'अधिकतम 12 छवियाँ, प्रत्येक 8 MB। निर्देशिका में दिखेंगी; प्रतीक चिह्न पता अलग है।' },
  ...
  'superadmin.adminEmail': { en: 'Admin Email (for password reset)', hi: 'प्रशासक ईमेल (कूटशब्द रीसेट के लिए)' },
