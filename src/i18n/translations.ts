...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'signup.flatSeriesFrom': { en: 'Flat range from (e.g. 101)', hi: 'फ्लैट रेंज से (जैसे 101)' },
  'signup.flatSeriesTo': { en: 'Flat range to (e.g. 111)', hi: 'फ्लैट रेंज तक (जैसे 111)' },
  ...
  'signup.adminId': { en: 'Admin ID', hi: 'एडमिन आईडी' },
  'signup.adminPassword': { en: 'Admin password', hi: 'एडमिन पासवर्ड' },
  ...
  'signup.gotoHome': { en: 'Go to login', hi: 'लॉगिन पर जाएँ' },
  ...
  'nav.duty': { en: 'Duty', hi: 'ड्यूटी' },

  // Guard daily duty (supervisor shift log)
  'duty.title': { en: 'Daily Duty', hi: 'दैनिक ड्यूटी' },
  'duty.staffTitle': { en: 'Staff attendance', hi: 'स्टाफ हाज़िरी' },
  'duty.staffHint': { en: 'Tap present / absent — no typing needed', hi: 'हाज़िर / गैरहाज़िर टैप करें — लिखने की ज़रूरत नहीं' },
  'duty.checksTitle': { en: 'Building checks', hi: 'बिल्डिंग जाँच' },
  'duty.checksHint': { en: 'Tap each item and choose status', hi: 'हर आइटम टैप करके स्थिति चुनें' },
  'duty.incidentTitle': { en: 'Report problem', hi: 'समस्या दर्ज करें' },
  'duty.incidentHint': { en: 'Tap type, then severity — optional photo', hi: 'प्रकार और गंभीरता टैप करें — फोटो वैकल्पिक' },
  'duty.saved': { en: 'Saved', hi: 'सेव हो गया' },
  'duty.saveFailed': { en: 'Could not save', hi: 'सेव नहीं हुआ' },
  'duty.loadError': { en: 'Could not load duty sheet', hi: 'ड्यूटी शीट लोड नहीं हुई' },
  'duty.alreadySubmitted': { en: 'Shift report sent', hi: 'शिफ्ट रिपोर्ट भेज दी' },
  'duty.inProgress': { en: 'In progress', hi: 'चल रही है' },
  'duty.submitShift': { en: 'Send shift report', hi: 'शिफ्ट रिपोर्ट भेजें' },
  'duty.submitTitle': { en: 'Send report to society?', hi: 'सोसाइटी को रिपोर्ट भेजें?' },
  'duty.submitDesc': { en: 'Admin can see staff, checks and problems from your shift.', hi: 'एडमिन आपकी शिफ्ट की हाज़िरी, जाँच और समस्याएँ देख सकते हैं।' },
  'duty.submitConfirm': { en: 'Yes, send', hi: 'हाँ, भेजें' },
  'duty.submitted': { en: 'Report sent', hi: 'रिपोर्ट भेज दी' },
  ...
  'duty.saveIncident': { en: 'Save report', hi: 'रिपोर्ट सेव करें' },
  'duty.incidentSaved': { en: 'Problem recorded', hi: 'समस्या दर्ज हो गई' },
  'duty.todayIncidents': { en: 'Today\'s reports', hi: 'आज की रिपोर्टें' },
  'duty.visitorLogs': { en: 'Visitor logs', hi: 'विज़िटर लॉग' },
  'duty.adminTab': { en: 'Guard duty', hi: 'गार्ड ड्यूटी' },
  'duty.noReports': { en: 'No duty reports yet', hi: 'अभी कोई ड्यूटी रिपोर्ट नहीं' },
  'duty.noIssues': { en: 'No problems reported', hi: 'कोई समस्या दर्ज नहीं' },
  'duty.issues': { en: 'issues', hi: 'समस्याएँ' },
  'duty.reports': { en: 'reports', hi: 'रिपोर्टें' },
  ...
  'duty.check.fire_alarm': { en: 'Fire alarm', hi: 'फायर अलार्म' },
  ...
  'duty.preset.no_recording': { en: 'No recording', hi: 'रिकॉर्डिंग नहीं' },
  ...
  'duty.preset.false_alarm': { en: 'False alarm', hi: 'गलत अलार्म' },
  ...
  'duty.preset.recording_missing': { en: 'No recording', hi: 'रिकॉर्डिंग नहीं' },
  ...
  // Report
  'report.title': { en: 'REPORTS', hi: 'रिपोर्ट्स' },
  'report.subtitle': { en: 'Society summary, finance net & export', hi: 'सोसाइटी सार, वित्त नेट और निर्यात' },
  'report.financeSummaryReceipts': { en: 'Receipts & ledger (by mode)', hi: 'रसीद और लेजर (मोड अनुसार)' },
  ...
  'settings.subtitle': { en: 'App configuration', hi: 'ऐप कॉन्फ़िगरेशन' },
  'settings.appearance': { en: 'Appearance', hi: 'दिखावट' },
  'settings.theme': { en: 'Theme', hi: 'थीम' },
  'settings.language': { en: 'Language', hi: 'भाषा' },
  'settings.autoCaps': { en: 'Auto CAPS for entries', hi: 'एंट्री के लिए ऑटो कैप्स' },
  'settings.autoCapsHint': {
    en: 'Names, titles, notes — phone & passwords stay as typed',
    hi: 'नाम, शीर्षक, नोट्स — फोन और पासवर्ड जैसे टाइप किए गए रहेंगे',
  },
  'settings.dataSummary': { en: 'Data Summary', hi: 'डेटा सारांश' },
  'settings.banners': { en: 'Dashboard login banners', hi: 'डैशबोर्ड प्रवेश बैनर' },
  'settings.bannersHint': {
    ...
    hi: 'ये चित्र निवासी डैशबोर्ड पर प्रवेश के बाद पॉपअप श्रृंखला के रूप में दिखते हैं (केवल डैशबोर्ड)। शीर्षक शुद्ध हिंदी (देवनागरी) में लिखें — रोमन हिंग्लिश जैसे “Agantukon ke liye niyam” से बचें।',
  },
  ...
  'settings.bannerAdded': { en: 'Banner added', hi: 'बैनर जोड़ा गया' },
  'settings.bannerRemoved': { en: 'Banner removed', hi: 'बैनर हटाया गया' },
  ...
  'settings.bannersEmpty': { en: 'No banners added yet.', hi: 'अभी कोई बैनर नहीं जोड़ा गया।' },
  'settings.bannerActive': { en: 'Active', hi: 'सक्रिय' },
  'settings.bannerAdd': { en: 'Add', hi: 'जोड़ें' },
  'settings.bannerUploading': { en: 'Uploading…', hi: 'अपलोड हो रहा है…' },
  ...
  'adminNav.visitor': { en: 'Visitor', hi: 'विज़िटर' },
  'adminNav.delivery': { en: 'Delivery', hi: 'डिलीवरी' },
  'adminNav.vehicles': { en: 'Vehicles', hi: 'वाहन' },
  'adminNav.blacklist': { en: 'Blacklist', hi: 'ब्लैकलिस्ट' },
  'adminNav.directory': { en: 'Directory', hi: 'निर्देशिका' },
  'adminNav.quick': { en: 'Quick', hi: 'क्विक' },
  'adminNav.reports': { en: 'Reports', hi: 'रिपोर्ट्स' },
  'adminNav.logs': { en: 'Logs', hi: 'लॉग्स' },
  'adminNav.audit': { en: 'Audit', hi: 'ऑडिट' },
  'adminNav.password': { en: 'Password', hi: 'पासवर्ड' },
  'adminNav.biometric': { en: 'Biometric', hi: 'बायोमेट्रिक' },
  'adminNav.settings': { en: 'Settings', hi: 'सेटिंग्स' },
  'adminNav.tour': { en: 'Tour', hi: 'टूर' },
  ...
  'resident.profile': { en: 'Profile', hi: 'प्रोफ़ाइल' },
  ...
  'superadmin.uploadLogo': { en: 'Upload society logo', hi: 'सोसाइटी लोगो अपलोड करें' },
  'superadmin.logoUploadOnSave': { en: 'uploads when you save', hi: 'सहेजने पर अपलोड होगा' },
  'superadmin.mobileBranding': { en: 'Mobile app branding', hi: 'मोबाइल ऐप ब्रांडिंग' },
  'superadmin.mobileBrandingHelp': { en: 'Logo and colors for Android & iOS Flutter apps. Web app is unchanged.', hi: 'Android और iOS Flutter ऐप के लिए लोगो और रंग। वेब ऐप अपरिवर्तित रहेगा।' },
  'superadmin.uploadAppLogo': { en: 'Upload app logo', hi: 'ऐप लोगो अपलोड करें' },
  ...
  'votingCharter.nomination.p1': {
    ...
    hi: 'जब एडमिन नामांकन विंडो खोलता है, पात्र सदस्य प्रबंध समिति के पदों — अध्यक्ष, उपाध्यक्ष, सचिव, कोषाध्यक्ष या कार्यकारिणी सदस्य — के लिए स्वयं को प्रस्तावित कर सकते हैं।',
  },
  ...
  'votingCharter.nomination.p3': {
    ...
    hi: 'स्व-नामांकन केवल एडमिन द्वारा निर्धारित नामांकन तिथियों में, और बकाया से अयोग्य न होने वाले सदस्यों के लिए ही अनुमत है।',
  },
  ...
  'votingCharter.method.p4': {
    ...
    hi: 'मतदान केवल एडमिन द्वारा निर्धारित मतदान विंडो में और चुनाव कोरम (सदस्यों का 3/4) पूरा होने पर ही अनुमत है।',
  },
  ...
  'votingCharter.docs.p1': {
    ...
    hi: 'एडमिन चुनाव में परिपत्र, पत्र या अन्य सोसाइटी दस्तावेज़ संलग्न कर सकता है; सदस्य उन्हें पोल से खोल सकते हैं।',
  },
  'votingCharter.docs.p2': {
    ...
    hi: 'मतदान बंद होने के बाद परिणाम गिने और ऑडिट किए जाते हैं। पूर्ण होने पर पूर्ण चुनाव रिपोर्ट और वार्षिक आम सभा चुनाव कार्यवृत्त तैयार होते हैं।',
  },
  'votingCharter.docs.p3': {
    ...
    hi: 'निर्वाचित समिति के नाम निवासी समिति मॉड्यूल में तभी दिखते हैं जब एडमिन रोस्टर प्रकाशित करता है।',
  },
  ...
  'votingCharter.shareMessage': {
    ...
    hi: 'सोसाइटी चुनाव चार्टर — पंजीकृत उपविधियों के अनुसार समिति के 7 सदस्यों का चुनाव।',
  },
