...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'settings.banners': { en: 'Dashboard login banners', hi: 'डैशबोर्ड लॉगिन बैनर' },
  'settings.bannersHint': {
    en: 'These images show as a popup carousel on the resident dashboard when a user logs in (dashboard only).',
    hi: 'ये चित्र निवासी डैशबोर्ड पर लॉगिन के बाद पॉपअप कैरोसेल के रूप में दिखते हैं (केवल डैशबोर्ड)।',
  },
