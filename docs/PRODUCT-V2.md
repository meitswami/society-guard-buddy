...
>
> **Already shipped in V2.0** (not repeated here): meetings module, finance ledger + period report + Transactions tab, self-audit engine, RBAC tab-level permissions, MC elections, events & food expenses (flat/outsider receipts, edit/delete, pool adjustments), committee roster, emergency alerts, head/reserve funds, guard photos, notification batching + read receipts, and related migrations through `20260608140000`.
