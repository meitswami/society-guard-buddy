...
const _hiSteps = <VotingCharterStep>[
  ...
  VotingCharterStep(
    ...
    detail:
        'प्रकाशन के बाद सदस्य समिति खंड में समिति देख सकते हैं। पहली प्रबंध समिति बैठक चुनाव के 30 दिनों के भीतर निर्धारित होनी चाहिए। सामान्य बैठक कोरम 7 में से 5 है; नियमित बैठकें कम-से-कम मासिक, सात स्पष्ट दिनों की सूचना के साथ।',
  ),
];
...
const _hiSections = <VotingCharterSection>[
  ...
  VotingCharterSection(
    heading: 'नामांकन',
    points: [
      'जब प्रशासक नामांकन अवधि खोलता है, पात्र सदस्य प्रबंध समिति के पदों — अध्यक्ष, उपाध्यक्ष, सचिव, कोषाध्यक्ष या कार्यकारिणी सदस्य — के लिए स्वयं को प्रस्तावित कर सकते हैं।',
      'प्रत्येक नामांकित को संक्षिप्त विवरण लिखना होगा। सेवानिवृत्त सदस्य पुनः चुनाव के लिए पात्र रहते हैं।',
      'स्व-नामांकन केवल प्रशासक द्वारा निर्धारित नामांकन तिथियों में, और बकाया से अयोग्य न होने वाले सदस्यों के लिए ही अनुमत है।',
    ],
  ),
  VotingCharterSection(
    heading: 'मतदान विधि',
    points: [
      ...
      'मतदान केवल प्रशासक द्वारा निर्धारित मतदान अवधि में और चुनाव कोरम (सदस्यों का 3/4) पूरा होने पर ही अनुमत है।',
    ],
  ),
  VotingCharterSection(
  ...
  VotingCharterSection(
    ...
    points: [
      'प्रशासक चुनाव में परिपत्र, पत्र या अन्य सोसाइटी दस्तावेज़ संलग्न कर सकता है; सदस्य उन्हें मतदान से खोल सकते हैं।',
      'मतदान बंद होने के बाद परिणाम गिने और लेखा-परीक्षा किए जाते हैं। पूर्ण होने पर पूर्ण चुनाव प्रतिवेदन और वार्षिक आम सभा चुनाव कार्यवृत्त तैयार होते हैं।',
...
VotingCharterContent votingCharterContent(CharterLang lang) {
  if (lang == CharterLang.hi) {
    return const VotingCharterContent(
      ...
      shareMessage:
          'सोसाइटी चुनाव नियमपत्र — पंजीकृत उपविधियों के अनुसार समिति के 7 सदस्यों का चुनाव।',
    );
  }
  return const VotingCharterContent(
