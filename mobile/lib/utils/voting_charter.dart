...
const _hiSteps = <VotingCharterStep>[
  VotingCharterStep(
    ...
    detail:
        'प्रबंध समिति में सात सदस्य होते हैं—अध्यक्ष, उपाध्यक्ष, सचिव, कोषाध्यक्ष तथा तीन कार्यकारिणी सदस्य। कार्यकाल दो वर्ष का है; निवृत्त सदस्य पुनः निर्वाचन हेतु खड़े हो सकते हैं।',
  ),
  VotingCharterStep(
    title: 'नामांकन अवधि में नामांकन करें',
    detail:
        'नामांकन खुला होने पर पात्र सदस्य (चुनाव तिथि पर 60 दिनों से अधिक अनुरक्षण बकाया न हो) रिक्त पद के लिए संक्षिप्त विवरण सहित स्वयं नामांकन कर सकते हैं।',
  ),
  VotingCharterStep(
    title: 'अपना मत डालें',
    detail:
        'प्रत्येक पात्र सदस्य को एक मत है। मतदान गुप्त मतपत्र अथवा हाथ उठाकर होगा—विधि मतदान आरंभ होने से पूर्व दर्ज की जाएगी। प्रॉक्सी हेतु बैठक से कम-से-कम 48 घंटे पूर्व लिखित प्राधिकरण आवश्यक है (एक व्यक्ति केवल एक सदस्य का प्रॉक्सी हो सकता है)।',
  ),
  VotingCharterStep(
    title: 'कोरम और पात्रता',
    detail:
        'चुनाव कोरम कुल सदस्यों का 3/4 है (30 सदस्यों के लिए न्यूनतम 23)। चुनाव तिथि पर 60 दिनों से अधिक अनुरक्षण/साझा व्यय बकाया वाले सदस्य मतदान अथवा निर्वाचन नहीं कर सकते। संयुक्त स्वामित्व में नामित-सदस्य नियम लागू होता है।',
  ),
  VotingCharterStep(
    title: 'परिणाम और सात पद',
    detail:
        'घोषित परिणाम प्रबंध समिति के सात पद भरते हैं। द्वितीय अथवा तृतीय स्थान के अभ्यर्थी स्वतः समिति सदस्य नहीं बनते। रिक्तियाँ उपविधि की रिक्ति-प्रक्रिया के अनुसार भरी जाती हैं।',
  ),
  VotingCharterStep(
    title: 'सूची प्रकाशित करें और पहली बैठक',
    detail:
        'प्रकाशन के पश्चात् सदस्य समिति खंड में समिति देख सकते हैं। प्रबंध समिति की प्रथम बैठक चुनाव के 30 दिनों के भीतर निर्धारित होनी चाहिए। सामान्य बैठक का कोरम 7 में से 5 है; नियमित बैठकें कम-से-कम मासिक, सात स्पष्ट दिनों की सूचना सहित।',
  ),
];
...
VotingCharterContent votingCharterContent(CharterLang lang) {
  if (lang == CharterLang.hi) {
    return const VotingCharterContent(
      ...
      programIntro:
          'पंजीकृत उपविधियों के अनुसार सोसायटी की सात-सदस्यीय प्रबंध समिति के चुनाव हेतु निम्नलिखित चरण अपनाएँ।',
      rulesHeading: 'उपविधि के नियम',
      steps: _hiSteps,
